...
namespace z5 {
    ...
    public:
        ...
        static const char must_exist = 4;
        static const char must_not_exist = 8;
        static const char should_truncate = 16;
        ...
        enum modes {r   = must_exist,
                    r_p = must_exist | can_write,
        ...
        inline bool mustExist() const {return mode_ & must_not_exist;}

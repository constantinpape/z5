...
project = 'z5py'
copyright = '2018, Constantin Pape'
...
latex_documents = [
    (master_doc, 'z5py.tex', 'z5py Documentation',
     'Constantin Pape', 'manual'),
]
...
man_pages = [
    (master_doc, 'z5py', 'z5py Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'z5py', 'z5py Documentation',
     author, 'z5py', 'One line description of project.',
     'Miscellaneous'),
]

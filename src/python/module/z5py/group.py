...
class Group(Mapping):
    ...
    def __getitem__(self, name):
        ...
        Access a dataset or group in the container.
    ...
    def create_group(self, name):
        ...
        Create new (sub-)group of the current container.
    ...
    def require_group(self, name):
        ...
        The group will be created if it does not exit already.
    ...
    def create_dataset(self, name,
        ...
        Create a new chunked dataset in the container. Syntax and behaviour similar to the
        ...
        Args:
            ...
            chunks (tuple): chunk sizes of the new dataset. If no chunks are given,
                            a suitable default value for the number of dimensions will be used
                            (default: None)
            compression (str): name of the compression library used to compress chunks.
                               If no compression is given, the default for the current format is used.
                               (default: None)
    ...
    def require_dataset(self, name, shape,
        ...
        Require dataset in the container.
        Will create the dataset if it does not exist, otherwise returns
        existing dataset. If the dataset exists already, consistency with the
        arguments ``shape``, ``dtype`` (if given) and ``chunks`` (if given)
        is enforced.
